...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'features.messaging.quote_message',
        'features.messaging.last_messages',
        'features.messaging.remove_friend',
        'features.friends.friend_service',
        ...
        'authencation.activation_plans', 'authencation.server_license', 'authencation.license_gate', 'cryptography.fernet', 'dotenv'
    ],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
